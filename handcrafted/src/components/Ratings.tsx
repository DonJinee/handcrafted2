    ...
    return (
        <section className="py-12 px-6 bg-gradient-to-r from-muted to-background m-4 rounded-lg mt-4 md:mt-0">
            <div className="h-auto rounded-xl border-2 p-8 grid grid-cols-4 w-auto">
                ...
                <div className="col-start-1 col-end-4 border-none md:border-l-2">
                    ...
                    <Link href="#recommend">
                    <button type="submit" className="bg-muted hover:bg-link transition duration-30 text-white font-bold py-2 px-4 rounded font-heading mt-10 md:mt-28">Start Review</button>
                    </Link>
                </div>
            </div>
            <div id="recommend" className="h-auto rounded-xl border-2 p-10 grid grid-cols-4 w-auto mt-16">
                <div className="hidden md:block">
                <Image 
                        width={200}
                        height={400}
                ...
                <div className="col-start-1 col-end-4 border-none md:border-l-2 p-2">
                    ...
                    <Link href="#">
                    <button type="submit" onClick={Alert} className="bg-muted hover:bg-link transition duration-30 text-white font-bold py-2 px-4 rounded font-heading mt-10 md:mt-28">Submit Review</button>
                    </Link>
                </div>
            </div>
        </section>
